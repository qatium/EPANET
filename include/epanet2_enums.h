...
typedef enum {
  ...
  EN_INTERNAL_STATUS    = 23, //!< Current link internal status (see @ref EN_LinkInternalStatusType)
} EN_LinkProperty;
...
/**
One of these values is returned when @ref EN_getlinkvalue is used to retrieve a link's
internal status ( \b EN_INTERNAL_STATUS ). These options are also used with
